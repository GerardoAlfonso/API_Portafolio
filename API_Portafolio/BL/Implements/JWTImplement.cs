...
namespace API_Portafolio.BL.Implements
{
    public class JWTImplement : JWTDAO
    {
        public JWTRequest create_token(JWTRequest jwtr)
        {
            ...
            tokenRequest.token = tokenHandler.WriteToken(token);
        ...
        public JWTRequest validate_token(JWTRequest jwtr)
        {
            ...
            catch (SecurityTokenException S)
            {
                return jwtToken;
            }
            catch (Exception ex)
